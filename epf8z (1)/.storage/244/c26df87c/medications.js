...
const medications = [
  {
    ...
    dosing: {
      cardiac: {
        ...
        notes: "Maximum single dose: 1 mg"
      }
    },
  ...
  },
  {
    ...
    dosing: {
      im: {
        ...
        min: 0.05,
        max: 0.3,
        interval: "Every 5-15 minutes as needed",
        notes: "Maximum single dose: 0.3 mg, Use 1:1,000 concentration"
      },
      iv: {
        dose: 0.001,
        unit: "mg/kg",
        min: 0.1,
        max: null,
        interval: "May repeat every 5-15 minutes",
        notes: "For severe shock only; use 1:10,000 concentration; administer over 5 minutes"
      }
    },
  ...
  },
  {
    ...
    dosing: {
      vf_vt: {
        ...
        min: null,
        max: 300,
        interval: "Can repeat up to total 15 mg/kg/day",
        notes: "Administer rapid bolus during cardiac arrest"
      },
      perfusing: {
        dose: 5,
        unit: "mg/kg",
        min: null,
        max: 300,
        interval: "Over 20-60 minutes",
        notes: "Slower administration for perfusing rhythms"
      }
    },
  ...
  },
  {
    ...
    dosing: {
      bradycardia: {
        ...
        notes: "Maximum total dose: 1 mg in child, 3 mg in adolescent"
      },
      poisoning: {
        dose: 0.05,
        unit: "mg/kg",
        min: null,
        max: null,
        interval: "Repeat every 2-5 minutes as needed",
        notes: "No maximum dose in organophosphate poisoning"
      }
    },
