...
const medications = [
  ...
  },
  {
    ...
    dosing: [
      {
        indication: "Supraventricular tachycardia (first dose)",
        min: 0.1,
        max: 0.1,
        unit: "mg/kg",
        route: "IV",
      ...
      {
        indication: "Supraventricular tachycardia (second dose)",
        min: 0.2,
        max: 0.2,
        unit: "mg/kg",
        route: "IV",
        maxDose: 12,
        notes: "If needed, give second dose. Rapid IV push over 1-2 seconds, followed by immediate saline flush."
      }
    ],
    preparation: "Undiluted",
  ...
  },
  {
    ...
    dosing: [
      {
        indication: "Hypoglycemia (Neonate)",
        min: 0.5,
        max: 0.5,
        unit: "g/kg",
        route: "IV/IO",
        maxDose: null,
        notes: "Use D10W 5 mL/kg. As needed for hypoglycemia."
      },
      {
        indication: "Hypoglycemia (Infant/Child)",
        min: 0.5,
        max: 0.5,
        unit: "g/kg",
        route: "IV/IO",
        maxDose: 25,
        notes: "Use D25W 2 mL/kg. As needed for hypoglycemia."
      },
      {
        indication: "Hypoglycemia (Adolescent)",
        min: 0.5,
        max: 0.5,
        unit: "g/kg",
        route: "IV/IO",
        maxDose: 25,
        notes: "Use D50W 1 mL/kg. As needed for hypoglycemia."
      }
    ],
    ...
    dosing: [
      {
        ...
        route: "IV/IO/IM/IN",
        maxDose: 2,
        notes: "May repeat every 2-3 minutes as needed. Higher doses may be needed for synthetic opioids."
      }
    ],
    preparation: "Undiluted",
  ...
  },
  {
    ...
    dosing: [
      {
        indication: "Seizures (IV/IO)",
        min: 0.15,
        max: 0.15,
        unit: "mg/kg",
        route: "IV/IO",
        maxDose: 10,
        notes: "May repeat every 5 minutes up to 3 doses."
      },
      {
        indication: "Seizures (IM/IN)",
        min: 0.2,
        max: 0.2,
        unit: "mg/kg",
        route: "IM/IN",
      ...
      },
      {
        ...
        route: "IV/IO",
        maxDose: 2.5,
        notes: "Titrate to effect. Reduce dose in combination with other sedatives."
      }
    ],
    ...
    dosing: [
      {
        ...
        route: "IV/IO",
        maxDose: 5,
        notes: "May repeat every 15-30 minutes. Titrate to effect."
      },
      {
        ...
        route: "IV/IO",
        maxDose: 3,
        notes: "May repeat every 15-30 minutes. Monitor respiratory status closely."
      }
    ],
    ...
    dosing: [
      {
        ...
        route: "IV/IO",
        maxDose: 4,
        notes: "May repeat once after 10-15 minutes. Administer no faster than 2 mg/minute."
      },
      {
        ...
        route: "IV/IO",
        maxDose: 2,
        notes: "Every 4-6 hours as needed. Lower doses for anxiolysis."
      }
    ],
